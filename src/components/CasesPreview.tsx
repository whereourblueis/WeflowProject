...
export default function CasesPreview() {
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      <div className="flex flex-col justify-between rounded-2xl bg-blue-600 p-8 text-white">
        <div>
        ...
        <Link
          href="/diagnosis"
          className="mt-6 inline-flex w-fit items-center gap-1 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-blue-600 transition-colors hover:bg-blue-50"
        >
